            ...
            <Container className='main about'>
                <Row>
                    <Col sm={{span: 12, offset: 0}} md={{span: 8, offset: 2}} lg={{span: 6, offset: 3}}>
                        <h1>About project</h1>
                        <p>Pixem app is an online tool that helps you convert pixels into different relative and
                        ...
                        <p>This app has been made in order to lessen the hassle of converting these values yourself, so
                            ...
                            you just need a quick pixel's converter. The visualizer and code generator added in the
                            application can also help you.</p>
                    </Col>
                </Row>
            </Container>
        </MainContainer>
